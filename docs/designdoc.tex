...
\item Startup ACK data == 0x00 and recover(signature) == key A or key C
\end{itemize}
...
Packet Magic & Checksum & Length & Data & Signature\tabularnewline
\hline 
(1 byte) & (4 bytes) & (1 byte) & (4 bytes) & (64 bytes)\tabularnewline
\hline 
