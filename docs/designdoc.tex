...
\hline 
(1 byte) & (4 bytes) & (1 byte) & (6 bytes) & (65 bytes)\tabularnewline
\hline 
...
\hline 
(1 byte) & (4 bytes) & (1 byte) & (192 bytes) & (65 bytes)\tabularnewline
\hline 
 &  & 0xC0 &  & \tabularnewline
\hline 
...
Packet Magic & Checksum & Length & Data\tabularnewline
\hline 
(1 byte) & (4 bytes) & (1 byte) & (32 bytes)\tabularnewline
\hline 
 &  & 0x20 & \tabularnewline
\hline 
\end{tabular}\caption{Replace Data Packet}
\end{table}
...
\multicolumn{2}{|c|}{Header} & \multicolumn{2}{c|}{Payload}\tabularnewline
\hline 
Packet Magic & Checksum & Length & Signature\tabularnewline
\hline 
(1 byte) & (4 bytes) & (1 byte) & (65 bytes)\tabularnewline
\hline 
 &  & 0x41 & \tabularnewline
\hline 
\end{tabular}\caption{Replace ACK Packet}
\end{table}
...
\begin{itemize}
\item Store public keys C and private key A on AP
\item Store public key A and private key C on Component1
\item Store public key A and private key C on Component2
\end{itemize}
...
Packet Magic & Checksum & Length & Data & Signature\tabularnewline
\hline 
(1 byte) & (4 bytes) & (1 byte) & (4 bytes) & (65 bytes)\tabularnewline
\hline 
 &  & 0x04 & 0x424F4F54 & \tabularnewline
\hline 
...
\hline 
(1 byte) & (4 bytes) & (1 byte) & (64 bytes) & (65 bytes)\tabularnewline
\hline 
 &  & 0x40 &  & \tabularnewline
\hline 
...
\hline 
Packet Magic & Checksum & Payload Magic & Length - 1 & Nonce & Data & HMAC\tabularnewline
\hline 
...
\hline 
(1 byte) & (4 bytes) & (1 byte) & (64 bytes) & (32 bytes)\tabularnewline
\hline 
 &  & 0x60 &  & \tabularnewline
\hline 
